...
public interface OrgRepository extends CrudRepository<Organisation, Long> {
    ...
    List<Application> findApplicationPartial(@Param("id") Long id, @Param("name") String name);
    ...
    Iterable<Application> findApplicationSort(@Param("id") Long id, @Param("sort") String sort);
}
